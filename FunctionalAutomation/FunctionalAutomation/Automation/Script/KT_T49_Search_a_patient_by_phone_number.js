...
//@patientSearch
function KT_T49_Search_a_patient_by_phone_number()
{
  try
  {
      aqTestCase.Begin("KT-T49_Search_a_patient_by_phone_number");
      ...
      //<Step 3>-Prefix the search with a '+' symbol in the search bar. Verify that the corresponding patient name and number appears under the "ALL PATIENTS" section
      PG_PatientDialogBox.searchPatientByName("+"+dataDriver.getValue("PhoneNumber"));
      ...
      PG_Patient_Jacket.validateContactNumber("0"+dataDriver.getValue("PhoneNumber"));
