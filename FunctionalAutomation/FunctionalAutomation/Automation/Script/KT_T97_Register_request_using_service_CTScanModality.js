...
var serviceName = dataDriver.getValue("CTScanModality");
var privateInvoiceType = dataDriver.getValue("PrivateInvoiceType");

function KT_T97_Register_request_using_service_CTScanModality() {
    try {
        aqTestCase.Begin("KT_T97_Register_request_using_service_CTScanModality");
