...
//@patientSearch
function KT_T7_Search_a_patient_by_DOB_in_MM_DD_YYYY()
{
  try
  {

    aqTestCase.Begin("KT-T7_Search_a_patient_by_DOB_in_MM_DD_YYYY");
    ...
    //<Step 3>-Enter the patient's DOB in "MM/DD/YYYY" format using slash operator in the search bar. Verify that the corresponding patient name and number appears under the "ALL PATIENTS" section
    PG_PatientDialogBox.searchPatientByName(dataDriver.getValue("DOBWithSlash"));
