...
function KT_T113_Manage_Custom_Filter_Hospital_Only_Show() {
    try {
       KT_Register_Request.KT_T111_Register_a_request_with_different_Hospital_and_Ward();
        aqTestCase.Begin("KT_T113_Manage_Custom_Filter_Hospital_Only_Show");
        //<Step 1> to <step 4>
        filtering.preconditionForFiltering();

        //<Step 5>Enter a name "Hospital Only Show" under the "Caption" field
        PG_Filtering.clickAndEnterTextOnSearchBar("caption", "Hospital Only Show");

        //<Step 6>Under the "RELATED" section, for the field "Hospital" ,select the option "Only Show.." from the dropdown and click on the search bar magnifier icon
        PG_Filtering.clickAndSetValueOnCustomFilterFields("Related","Hospital", "Only Show");
      ...
      PG_Filtering.selectOptionOnWindowAndCloseWindow(hospital);
        ...
        PG_Filtering.clickOnFilteringOptions("Hospital Only Show");
