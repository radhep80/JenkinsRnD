...
//@patientSearch
function KT_T3_Search_a_patient_by_space_separator_Surname_FirstName()
{
  try
  {

      aqTestCase.Begin("KT-T3_Search_a_patient_by_space_separator_Surname_FirstName");
      ...
      PG_PatientDialogBox.searchPatientByName(dataDriver.getValue("PatientSearchBySpaceOparator"));
