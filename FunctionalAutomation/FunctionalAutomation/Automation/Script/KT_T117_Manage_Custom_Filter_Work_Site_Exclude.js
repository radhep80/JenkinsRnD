...
function KT_T117_Manage_Custom_Filter_Work_Site_Exclude()
{
   try {
        KT_Register_Request.KT_T59_Register_a_request();
        aqTestCase.Begin("KT_T114_Manage_Custom_Filter_Worksite_Exclude");
        //<Step 1> to <step 4>
        filtering.preconditionForFiltering();

        //<Step 5>Enter a name "Worksite Only show" under the "Caption" field
        PG_Filtering.clickAndEnterTextOnSearchBar("caption",globalConstants.worksiteExclude);
        ...
        PG_Filtering.clickAndSetValueOnCustomFilterFields("Related","Worksite", "Exclude");
        ...
        PG_Filtering.clickOnFilteringOptions(globalConstants.worksiteExclude);
