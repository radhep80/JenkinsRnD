...
var serviceName = dataDriver.getValue("MRIModality");
var privateInvoiceType = dataDriver.getValue("PrivateInvoiceType");

function KT_T98_Register_request_using_service_MRIModality() {
    try {
        aqTestCase.Begin("KT_T98_Register_request_using_service_MRIModality");
