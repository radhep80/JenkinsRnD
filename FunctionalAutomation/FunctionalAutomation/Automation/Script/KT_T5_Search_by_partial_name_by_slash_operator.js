...
//@patientSearch
function KT_T5_Search_a_patient_by_partial_surname_and_first_name_separated_by_slash()
{
  try
  {
      aqTestCase.Begin("KT-T5_Search_a_patient_by_partial_surname_and_first_name_separated_by_slash");
      ...
      //<Step 3>-Enter few initials of first name and surname separated by slash operator"<Surname>/<First Name>" in the search bar. Verify that the corresponding patient name and number appears under the "ALL PATIENTS" section
      PG_PatientDialogBox.searchPatientByName(dataDriver.getValue("PartialSurnameAndFirstNameSlashOprator"));
